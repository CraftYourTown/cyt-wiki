...
8. **Each player may use two Java accounts only** - if you share a house with another player and believe you will appear on the same IP address, or you have a new account that you’d like your data transferred to, you should create a ticket in our Discord and let us know beforehand
